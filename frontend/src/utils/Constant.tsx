...
export const ToastContent = (
  <>
    <em className="txt-danger">Attackers</em> on malicious activity may trick
    you into doing something dangrous like installing software or revealing your
...
export const FontawesomeThumbsUpDownRating =
  "Fontawesome Thumbs Up/Down rating";
...
export const VerticalPosition = " start / center / end / baseline / stretch";
export const HorizontalClass = ".justify-content-*";
export const HorizontalPosition = "start / ce end / around / between";
...
export const AlertsWithIconsandTextActions =
...
export const TimeLineData2 = (
  <div className="cd-timeline-content">
    ...
    <div className="ratio ratio-21x9 m-t-20">
      <iframe
        src="https://www.youtube.com/embed/sqRk0Ly66Ps"
        allowFullScreen
        title="abc"
      />
    </div>
...
export const TimeLineData4 = (
  <div className="cd-timeline-content">
    ...
    <P className="mb-0">
      So, the next time you listen to music, you might or might not consider how
      it's actively altering your mood.
    </P>
    <audio controls>
...
export const MasonryGalleryWithDescriptions =
...
export const CaptionSpan = [
  {
    text: `A <caption> functions like a heading for a table. It helps users with screen readers to find a table and understand what it’s about and decide if they want to read it.`,
  },
];
...
export const RowsSelectionAndDeletion =
...
export const OrderConfirmedDetails =
...
export const ShippingInformationText =
...
export const PaymentInformationText =
  "Fill up the following information to send you the order";
...
export const DisabledCheckedSwitchCheckboxInput =
...
export const MostImportantThingsToLearnAboutWebDesign =
  "What are the most important things to learn about web design?";
export const RadiosWithCreativeOptionsSVGIcons =
  "Radios With Creative Options & SVG Icons";
export const WhichActivitiesDoYouEnjoy =
...
export const ButtonsWithPrefixAndPostFixHeading =
...
export const ClipboardOnTextAreaValue =
...
export const ClipboardOnParagraphValue =
...
export const EnterYourPersonalDetails =
...
export const createNewCity = "Create New City";
export const createNewCRMModule = "Create New CRM Module";
export const createNewPackage = "Create New Package";
export const createNewProvince = "Create New Province";
export const citiesList = "Cities List";
export const citiesListHeading = "All Cities";
export const provinceList = "Province List";
export const provinceListHeading = "All Provinces";
export const crMmoduleList = "CRM Module List";
export const crmModuleListHeading = "All CRM Modules";
export const packageList = "Package List";
export const packageListHeading = "All Packages";
